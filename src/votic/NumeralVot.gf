concrete NumeralVot of Numeral = CatVot [Numeral,Digits] **  open Prelude, ParadigmsVot, MorphoVot in {
...
lincat
  Sub1000000 = {s : CardOrd => Str ; n : MorphoVot.Number} ;
  Digit = {s : CardOrd => Str} ;
  Sub10, Sub100, Sub1000 = {s : NumPlace => CardOrd => Str ; n : MorphoVot.Number} ;
...
oper
  ...
  sataaN : {s : MorphoVot.Number => CardOrd => Str} = {s = table {
    Sg => sadaN.s ;
    Pl => table {
  ...
  oper
    mk2Dig : Str -> Str -> TDigit = \c,o -> mk3Dig c o MorphoVot.Pl ;
    mkDig : Str -> TDigit = \c -> mk2Dig c (c + ".") ;

    mk3Dig : Str -> Str -> MorphoVot.Number -> TDigit = \c,o,n -> {
