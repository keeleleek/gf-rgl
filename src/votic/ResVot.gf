...
resource ResVot = ParamX ** open Prelude in {
...
-- For $Sentence$.
  ...
  -- SInv made by mkClause would be for cases where you just need to construct an inverted word order, and then call it from some other place; application grammar (TODO: api oper for SType) or ExtraVot.
...
--below moved here from MorphoVot
