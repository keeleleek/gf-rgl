...
incomplete concrete DocumentationVotFunctor of Documentation = CatVot ** open 
...
oper 
  verbExample : CatVot.Cl -> Str = \cl -> (S.mkUtt cl).s ;
{-
-} --# notpresent
  inflVerb : CatVot.V -> Str = \verb ->
     let 
       --verb = sverb2verbSep verb0 ;
       vfin : ResVot.VForm -> Str = \f ->
         verb.s ! f ;
