...
resource MorphoVot = ResVot ** open Prelude, Predef, HjkVot in {
...
----------------------
  ...
  -- TS 57 (lugema)
  -- Like 55-56 but irregular gradation patterns, that shouldn't be in HjkVot.weaker
...
{-  -- TS 60 (jatma)
  ...
  cJatma : (_ : Str) -> VForms = \jatma ->
    let
      ...
      --HjkVot.weaker takes care of kütma->köetud
    in vForms8
      jatma
      (jatt + "a")
      (jat + "ab")
...
{- Noun internal opers moved to ResVot
...
{-  Verb internal opers moved to ResVot
...
-- Here we define personal and relative pronouns.
  ...
  -- Vot pronouns thus seem to be much simpler.
  -- TODO: remove NPAcc?
  -- I: keep NPAcc; see appCompl in ResVot, it takes care of finding a right case for various types of complements; incl. when pronouns get different treatment than nouns (PassVP).
