...
--
-- The main difference with $MorphoVot.gf$ is that the types
...
-- verbs
  ...
  vForms4 : (x1,_,_,x4 : Str) -> VForms = \jatma,jatta,jatab,jaetakse ->
    ...
    -- regVForms in MorphoVot handles majority of these.
